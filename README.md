...
Run: 
Interactive: <code>docker run -p 8080:8080 bernalraul/pingexplorer-devnet6</code>
Deteached: <code>docker run -d -p 8080:8080 bernalraul/pingexplorer-devnet6</code>
